...
export function buildCommands(ctx: CommandCtx): Command[] {
  ...
  cmds.push(
    ...
    },
    {
      ...
      enabled: ctx.hasLayers,
      run: () => void actions.copySelection(),
    },
    {
      id: "edit:cut",
      title: "Cut",
    ...
    },
    {
      ...
      group: "Edit",
      hint: "⌘V",
      keywords: "clipboard layer",
      enabled: actions.hasClipboard(),
      run: () => void actions.pasteClipboard(),
    },
    {
      id: "edit:duplicate-layer",
      title: "Layer via copy",
      group: "Edit",
      hint: "⌘J",
      keywords: "duplicate selection new layer",
      enabled: ctx.hasLayers,
      run: () => void actions.duplicateSelectionToLayer(),
    },
    {
      ...
      group: "Edit",
      hint: "⌫",
      keywords: "delete erase remove pixels",
      enabled: ctx.hasLayers,
      run: () => actions.deleteSelectionContent(),
    },
  );
